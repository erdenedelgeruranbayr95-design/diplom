...
export default function StatCard({
  ...
  return (
    <div className="flex flex-row items-center gap-4 p-5 rounded-2xl bg-white/[.035] transition-[transform,background,box-shadow] duration-[350ms] ease-[cubic-bezier(.16,.8,.24,1)] hover:-translate-y-[3px] hover:bg-white/[.055] hover:shadow-sm">

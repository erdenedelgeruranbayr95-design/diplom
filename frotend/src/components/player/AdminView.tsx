...
export default function AdminView({
  ...
  return (
    <>
      ...
      <div className="rounded-2xl bg-white/[.035] p-6 mt-7 flex flex-col gap-4 transition-[box-shadow,border-color] duration-250 hover:border-white/[.14]">
      ...
      {!loading && !err && (
        <>
          ...
          {recentUsers.length === 0 ? (
            ...
            <div className="rounded-2xl overflow-hidden bg-white/[.035]">

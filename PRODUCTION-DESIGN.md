...
> ⚠️ **АНХААРУУЛГА (2026-08-04):** Энэ баримт доторх `FRONTEND-PHASES.md`
> холбоосууд (§857, §867, §878, §931, §945 орчим) хуучирсан — тэр файл
> `docs/archive/FRONTEND-PHASES.md` руу шилжсэн бөгөөд өнөөдрийн явцыг
> тусгаагүй. Одоогийн бодит явцыг **`ROADMAP-7-PHASES.md`**-ээс (root) харна уу.
...
> шинжилгээтэй, ХУУЧИРСАН) → **[`docs/archive/FRONTEND-PHASES.md`](./docs/archive/FRONTEND-PHASES.md)**
>

...
const likeBase =
  "absolute top-[9px] right-[9px] w-[34px] h-[34px] rounded-full flex items-center justify-center text-[17px] text-white bg-[rgba(5,9,9,.55)] backdrop-blur-sm opacity-0 transition-[opacity,color,transform] duration-[250ms] z-[2] hover:scale-[1.12] group-hover:opacity-100";

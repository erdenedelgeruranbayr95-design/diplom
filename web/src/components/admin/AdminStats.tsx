...
/* AdminPanel.tsx-ийн KPI блок — премиум dashboard KPI card (Stripe/Vercel Dashboard pattern)
   руу шинэчлэв: тод value, icon, тайлбар мөр. total/proCount props хэвээр — зөвхөн визуал
   давхарга шинэчлэгдсэн, шинэ metric нэмээгүй. */
export default function AdminStats({ total, proCount }: { total: number; proCount: number }) {
  return (
    <div className="grid grid-cols-2 gap-3 my-5 mb-6">

...
> ⚠️ **АРХИВЛАГДСАН (2026-08-04):** Энэ файл 2026-07-30-ний snapshot бөгөөд
> **хуучирсан** (жиш. backend модулийн тоо, `next/dynamic` ашиглалт зэрэг
> одоогийн кодтой зөрдөг). Одоогийн бодит явц, идэвхтэй ажлын жагсаалтыг
> **`ROADMAP-7-PHASES.md`**-ээс (root) харна уу. Энэ файлыг зөвхөн түүхэн
> лавлагаа болгон хадгалав.

...
/* Нэгдсэн товчны бүлэг — primary/secondary/ghost/danger зэрэглэлийг нэг дор тодорхойлно.
   Одоо байгаа бүх товчны className pattern-уудыг (bg-aqua/border-white/[.16]/text-danger)
...
const VARIANT_CLS: Record<Variant, string> = {
  primary:
    "bg-aqua text-on-aqua shadow-[inset_0_1px_0_rgba(255,255,255,.35),0_4px_14px_-4px_rgba(56,232,206,.5)] hover:bg-aqua-hover hover:shadow-[inset_0_1px_0_rgba(255,255,255,.4),0_6px_20px_-4px_rgba(56,232,206,.6)] active:scale-[.97] focus-visible:shadow-glow-aqua",
  secondary:
  ...
  danger:
    "text-danger border border-[rgba(232,138,155,.3)] hover:bg-danger hover:text-danger-ink active:scale-[.98] focus-visible:shadow-[0_0_0_2px_rgba(232,138,155,.6),0_0_0_5px_rgba(232,138,155,.18)]",
};

/* min-h нь хүрэлцэх төхөөрөмж дээрх hit-target-ийг хамгаална (WCAG 2.5.8) */
const SIZE_CLS = {
  sm: "text-note py-1.5 px-3.5 min-h-[30px]",
  md: "text-body py-2.5 px-5 min-h-[38px]",
  lg: "text-copy py-3 px-6 min-h-[44px]",
};

  ...
  return (
    <>
      <div className="relative mb-5">
        ...
        <input
          className="w-full pl-11 pr-4 py-3 rounded-full bg-white/[.05] border border-white/[.08] text-ink text-copy transition-[border-color,box-shadow,background] duration-250 focus:bg-white/[.08] focus:border-aqua/60 focus-visible:outline-none focus-visible:shadow-glow-aqua placeholder:text-faint"
        ...
        <TableCard>
          ...
          {patients.map((p) => (
            ...
            >
              ...
              <span className="text-faint font-mono text-caption">{new Date(p.createdAt).toLocaleDateString("mn-MN")}</span>

...
/* Дугтуйт (attack–decay) цохилтын түвшин тус бүрийн хэлбэр — `VIB_LEVELS`-ийн
   индекстэй харгалзана.

   `VIB_LEVELS.mult` нь ГАНЦ үржигч байсан тул цохилтын оргил ба урт хоёрыг
   тусад нь тохируулах боломжгүй байв. Дугтуйт импульс нь тэгш өнцөгттэй ижил
   оргилтой ч НИЙТ энерги нь бага (уналтын доорх талбай бага) тул хүчтэй
   түвшинд уртыг сунгаж энергийг барина. `mobile/src/lib/player/constants.ts`-ийн
   `BEAT_LEVELS`-тэй ИЖИЛ утгууд — хоёр платформ ижил мэдрэмж өгөх ёстой. */
export const BEAT_LEVELS = [
  { peak: 0.65, body: 0.8 }, // Сул
  { peak: 0.95, body: 1.0 }, // Дунд
  { peak: 1.0, body: 1.3 }, // Хүчтэй
];

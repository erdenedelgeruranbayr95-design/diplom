    ...
    <div className="min-h-[100svh] bg-bg text-ink px-4 py-5 md:px-6 md:py-6">
      <div className="mx-auto max-w-[820px]">
        ...
        <Section title="1. Үйлчилгээний тухай">
          <p>
            МЭДРЭХ (цаашид "Үйлчилгээ") нь дуу авиаг чичиргээ/гэрлийн дохио болгон хувиргах хөгжим-эмчилгээний
            платформ бөгөөд сонсголын бэрхшээлтэй хэрэглэгчид, тэдний эмч (THERAPIST) болон эцэг эх (PARENT)-д
            зориулагдсан. Үйлчилгээг ашигласнаар та энэхүү нөхцөлийг хүлээн зөвшөөрсөнд тооцно.
          </p>
        </Section>
        ...
        <Section title="2. Бүртгэл ба эрх">
          ...
          <p>Дүрийн (USER/PARENT/THERAPIST/ADMIN/ROOT) зориулалтын дагуу л эрхээ ашиглана. Эрхээ зөрчиж ашигласан тохиолдолд бүртгэл түдгэлзүүлэгдэж болно.</p>
        </Section>
        ...
        <Section title="5. Эмчилгээний зөвлөмж — хариуцлагын хязгаарлалт">
          <p>МЭДРЭХ дэх контент, тохиргоо, ахицын тайлан нь ЭМЧИЙН ОРОНД орлохгүй — туслах хэрэгсэл юм. Эмнэлгийн шийдвэрийг мэргэшсэн эмч/сонсголын мэргэжилтэнтэй зөвлөлдөж гаргана уу.</p>
        </Section>

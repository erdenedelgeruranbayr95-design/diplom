      ...
      <div className="mx-auto max-w-[820px]">
        ...
        <Section title="1. Ерөнхий">
          <p>
            ...
            хөгжмийн платформ юм. Энэхүү бодлого нь бид ямар хувийн мэдээлэл цуглуулж, хэрхэн ашиглаж,
        ...
        <Section title="2. Бид цуглуулдаг мэдээлэл">
          ...
          <p><b className="text-ink">Хэрэглээний өгөгдөл:</b> сонссон дуу, тоглуулсан огноо/хугацаа, дуртай/хадгалсан жагсаалт, сонсголын статистик.</p>
        ...
        <Section title="3. Мэдээллийг хэрхэн ашигладаг">
          <p>Үйлчилгээ үзүүлэх (тоглуулагч, санал болгол, PRO эрх идэвхжүүлэх), аюулгүй байдал хангах (нэвтрэлт, залилан илрүүлэх), үйлчилгээгээ сайжруулах (алдаа мониторинг, ашиглалтын статистик — нэрлэсэн бус нэгтгэсэн байдлаар).</p>
        ...
        <Section title="6. Өгөгдөл хадгалах хугацаа">
          <p>Бүртгэл идэвхтэй байх хугацаанд мэдээлэл хадгалагдана. Бүртгэл устгах хүсэлт ирсний дараа тухайн хэрэглэгчтэй холбоотой бүх өгөгдөл (профайл, сонсох түүх, жагсаалт) 30 хоногийн дотор устгагдана. Хуулиар шаардагдах санхүүгийн бүртгэл (жиш. төлбөрийн лог) хуулийн хугацаанд хадгалагдаж болно.</p>
        </Section>
